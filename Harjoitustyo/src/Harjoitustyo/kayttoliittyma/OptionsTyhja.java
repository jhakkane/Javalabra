...
public class OptionsTyhja extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        textArea1.setName("");
        textArea1.setText("Olet valinnut asetukset, joiden mukaan\npeli itse päättää minkälaisia kysymyksiä \nnäytetään. Et voi muuttaa asetuksia\ntässä pelissä, vaan sinun on aloitettava \nuusi peli, mikäli haluat säätää asetuksia.");
    ...
    public OptionsTyhja() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OptionsTyhja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
